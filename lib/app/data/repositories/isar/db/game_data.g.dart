...
const GameDataSchema = CollectionSchema(
  ...
  indexes: {},
  links: {
    r'platform': LinkSchema(
      id: -2460504369712459699,
      name: r'platform',
      target: r'PlatformData',
      single: true,
    ),
    r'overradedPlatform': LinkSchema(
      id: -3878400588627086998,
      name: r'overradedPlatform',
      target: r'PlatformData',
      single: true,
    )
  },
...
void _gameDataSerialize(
  ...
  writer.writeString(offsets[4], object.imageColor);
...
GameData _gameDataDeserialize(
  ...
  object.genre = reader.readStringOrNull(offsets[2]);
  object.id = id;
  object.image = reader.readStringOrNull(offsets[3]);
  object.imageColor = reader.readStringOrNull(offsets[4]);
...
List<IsarLinkBase<dynamic>> _gameDataGetLinks(GameData object) {
  return [object.platform, object.overradedPlatform];
}

void _gameDataAttach(IsarCollection<dynamic> col, Id id, GameData object) {
  object.id = id;
  object.platform
      .attach(col, col.isar.collection<PlatformData>(), r'platform', id);
  object.overradedPlatform.attach(
      col, col.isar.collection<PlatformData>(), r'overradedPlatform', id);
}
...
extension GameDataQueryFilter
  ...
  QueryBuilder<GameData, GameData, QAfterFilterCondition> categoriesIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(
        r'categories',
        0,
...
extension GameDataQueryLinks
    on QueryBuilder<GameData, GameData, QFilterCondition> {
  QueryBuilder<GameData, GameData, QAfterFilterCondition> platform(
      FilterQuery<PlatformData> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'platform');
    });
  }

  QueryBuilder<GameData, GameData, QAfterFilterCondition> platformIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'platform', 0, true, 0, true);
    });
  }

  QueryBuilder<GameData, GameData, QAfterFilterCondition> overradedPlatform(
      FilterQuery<PlatformData> q) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'overradedPlatform');
    });
  }

  QueryBuilder<GameData, GameData, QAfterFilterCondition>
      overradedPlatformIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'overradedPlatform', 0, true, 0, true);
    });
  }
}

extension GameDataQuerySortBy on QueryBuilder<GameData, GameData, QSortBy> {
  QueryBuilder<GameData, GameData, QAfterSortBy> sortByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByGenre() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByGenreDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByImageColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageColor', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByImageColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageColor', Sort.desc);
    });
  }
  ...
  QueryBuilder<GameData, GameData, QAfterSortBy> sortByPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByPublisher() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'publisher', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> sortByPublisherDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension GameDataQuerySortThenBy
  ...
  QueryBuilder<GameData, GameData, QAfterSortBy> thenByDescription() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByDescriptionDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'description', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByGenre() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByGenreDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'genre', Sort.desc);
    });
  }
  ...
  QueryBuilder<GameData, GameData, QAfterSortBy> thenByImage() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByImageDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'image', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByImageColor() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageColor', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByImageColorDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'imageColor', Sort.desc);
    });
  }
  ...
  QueryBuilder<GameData, GameData, QAfterSortBy> thenByPath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByPathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'path', Sort.desc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByPublisher() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'publisher', Sort.asc);
    });
  }

  QueryBuilder<GameData, GameData, QAfterSortBy> thenByPublisherDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'publisher', Sort.desc);
    });
  }
...
extension GameDataQueryWhereDistinct
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByCategories() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'categories');
    });
  }

  QueryBuilder<GameData, GameData, QDistinct> distinctByDescription(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByGenre(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByImage(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByImageColor(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'imageColor', caseSensitive: caseSensitive);
    });
  }
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByPath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<GameData, GameData, QDistinct> distinctByPublisher(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension GameDataQueryProperty
  ...
  QueryBuilder<GameData, List<String>, QQueryOperations> categoriesProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'categories');
    });
  }

  QueryBuilder<GameData, String, QQueryOperations> descriptionProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'description');
    });
  }

  QueryBuilder<GameData, String?, QQueryOperations> genreProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'genre');
    });
  }

  QueryBuilder<GameData, String?, QQueryOperations> imageProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'image');
    });
  }

  QueryBuilder<GameData, String?, QQueryOperations> imageColorProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'imageColor');
    });
  }
  ...
  QueryBuilder<GameData, String, QQueryOperations> pathProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'path');
    });
  }

  QueryBuilder<GameData, String?, QQueryOperations> publisherProperty() {
    return QueryBuilder.apply(this, (query) {
